...
const GodownActivities = () => {
    ...
    const getGodownActivities = async (from, to, dropValue) => {
        try {
            const response = await fetch(
                api.getGodownActivities(from, to, dropValue),
            );
    ...
    const renderItem = ({ item }) => {
        ...
        const grandTotal =
            parseFloat(dailyTotal.inward) +
            parseFloat(dailyTotal.management) +
            parseFloat(dailyTotal.outward);
                    ...
                    <View style={styles(colors).accordionView}>
                        <View style={styles(colors).accordionIconView}>
                            ...
                            <View>
                                <Text
                                    style={[
                                        styles(colors).accordionIconText,
                                        { color: colors.accent },
                                    ]}>
            ...
            <FlatList
                ...
                ListEmptyComponent={() => (
                    <View style={styles(colors).noDataContainer}>
                        <Text style={styles(colors).noDataText}>
                            No data to display
                        </Text>
                    </View>
                )}
